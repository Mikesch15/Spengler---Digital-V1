...
const CACHE = "spengler-digital-3.146";
...
const SHELL = [
  ...
  "./js/22-system-admin.js",
  "./js/23-verlauf.js",
  "./js/24-projekt-cockpit.js",
  "./js/25-kehle.js",
  "./js/26-rinne.js",
  "./js/27-offline.js",
  "./js/28-rinne-aufnahme.js",
  "./js/29-einlaufblech-aufnahme.js",
  "./js/30-einlaufblech-konisch-aufnahme.js",
  "./js/31-freies-profil-aufnahme.js",
  "./js/32-mauerabdeckung-aufnahme.js",
  "./js/33-zuschnitt.js",
  "./js/34-kehle-aufnahme.js",
  "./js/35-pdf-listen.js",
  "./js/36-lukarne-aufnahme.js",
  "./js/37-kamin-aufnahme.js",
