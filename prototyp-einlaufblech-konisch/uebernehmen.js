...
// und schreibt sie nach prototyp-einlaufblech-konisch/uebernommen.js.
//
// Aufruf aus dem Repo-Wurzelverzeichnis:  node prototyp-einlaufblech-konisch/uebernehmen.js
//
...
// Die Fachlogik des konischen Einlaufblechs liegt in ZWEI Dateien:
// js/13 traegt die geteilten Bausteine (Aufteilung, Rinnen-Uebernahme,
// Grundriss), der eigentliche Rechenkern (enges Mass, Restbreite) steht
// in js/14-freies-profil.js. Beide werden hier zeichengenau uebernommen.
const QUELLEN=[
 {datei:"js/11-einlaufblech-gerade.js", namen:["einlaufblechDiagramSvg"]},
 {datei:"js/13-einlaufblech-konisch.js",namen:["teileLaengeInStuecke","splitLengthIntoPieces","generateEbkGrundriss","baueEinlaufblechStueckeAusRinne"]},
 {datei:"js/14-freies-profil.js",       namen:["ansichtsPfeilSvg","calcEbkPiece","ebkRestbreite"]}
];

let text='"use strict";\n'
 +"// ==========================================================================\n"
 +"// AUS DER LAUFENDEN APP ÜBERNOMMEN - NICHT VON HAND BEARBEITEN.\n"
 +"// Erzeugt von prototyp-einlaufblech-konisch/uebernehmen.js; jede Funktion ist\n"
...
const ziel=path.join(wurzel,"prototyp-einlaufblech-konisch","uebernommen.js");
...
console.log("geschrieben: prototyp-einlaufblech-konisch/uebernommen.js");
