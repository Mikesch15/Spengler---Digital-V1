...
const WIN_CHANGELOG={
 ...
 "3.188":["<b>Neu: der Abwicklungsrechner.</b> 📐 Abwicklung auf dem Startbildschirm, in der neuen Ansicht unter <b>Mehr</b>. Er rechnet den Zuschnitt für ein rundes Blechrohr mit schrägem Anschnitt, angebogenem Kragen und liegendem Längsfalz – die Rechnung, die bisher nur als Fusion-360-Script ausserhalb der App lief.",
  "<b>Dieselbe Rechnung, nicht eine neue.</b> Das Script ist Zeile für Zeile nach JavaScript übertragen, nicht nachgebaut: der Kragen ist geometrisch nicht abwickelbar, und eine eigene Näherung wäre eine zweite Wahrheit neben der, nach der in der Werkstatt bisher geschnitten wurde. Die sieben Kontrollwerte des Auftrags trifft sie exakt (Umfang 343,38 · Zuschnittbreite 361,38 · Höhe 371,25/305,17 · Kragen-Zugabe 37,13…40,10 · Biegewinkel 60…120° · Streckung 67 %).",
  "<b>Massstäbliche Vorschau</b>, während Sie tippen: Zuschnitt durchgezogen, Biegelinie des Kragens rot gestrichelt, Falz blau, die Einschnitte für die Lappen dünn. Darunter die Tabelle mit allen Kennzahlen.",
  ...
  "<b>Die App warnt, wo es fachlich klemmt:</b> wenn die Kragen-Zugabe für die Krümmung zu gross wird, und wenn der Kragenrand über rund 10 % gestreckt würde und keine Lappen gesetzt sind – so lässt er sich nicht aufziehen."]
};
