...
// Kontrolle.
const EBKA_REGISTER=[
 {nr:1,kurz:"Grunddaten",hilfe:"reg-grunddaten"},{nr:2,kurz:"Geometrie",hilfe:"ebk-geometrie"},{nr:3,kurz:"Stücke",hilfe:"ebk-stuecke"},
...
function ebkaKarte(titel,inhalt){
 ...
 const h=(typeof hilfeKarte==="function")?hilfeKarte(titel,EBKA_REGISTER):"";
...
function ebkaZusatzDaten(){
 ...
 return {
  ...
  rollen:{auswahl:(ebkA.rollenAuswahl||[]).slice(),
          ...
          // v3.85: abschnittLaenge/abschnittNr je Streifen mitspeichern - bei
          // mehreren Abschnittlaengen (js/29 ebaPackeMehrereAbschnitte, v3.83)
          // braucht das ein spaeter aus dem gespeicherten Plan gerechneter
          // Zuschnitt (zuBilanz/restAlle), sonst kommt wieder die laengste
          // Laenge der Gruppe fuer jeden Streifen zum Einsatz.
