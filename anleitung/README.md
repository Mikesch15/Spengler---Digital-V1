...
`Spengler-DIGITAL-Anleitung-v3.164.pdf` – Bedienungsanleitung der App,
94 Seiten, mit Bildschirmfotos aus der App selbst.
...
Dann im Wurzelverzeichnis des Repos:
    ...
    PDF=anleitung/Spengler-DIGITAL-Anleitung-v3.164.pdf \
