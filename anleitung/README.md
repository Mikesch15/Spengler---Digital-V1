...
`Spengler-DIGITAL-Anleitung-v3.181.pdf` – Bedienungsanleitung der App,
100 Seiten, mit Bildschirmfotos aus der App selbst.
...
Dann im Wurzelverzeichnis des Repos:
    ...
    PDF=anleitung/Spengler-DIGITAL-Anleitung-v3.181.pdf \
