...
`Spengler-DIGITAL-Anleitung-v3.22.pdf` – Bedienungsanleitung der App,
64 Seiten, mit Bildschirmfotos aus der App selbst.
...
Dann im Wurzelverzeichnis des Repos:
    ...
    PDF=anleitung/Spengler-DIGITAL-Anleitung-v3.22.pdf \
