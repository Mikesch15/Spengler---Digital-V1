...
`Spengler-DIGITAL-Anleitung-v3.203.pdf` – Bedienungsanleitung der App,
113 Seiten, mit Bildschirmfotos aus der App selbst.
...
Dann im Wurzelverzeichnis des Repos:
    ...
    PDF=anleitung/Spengler-DIGITAL-Anleitung-v3.203.pdf \
